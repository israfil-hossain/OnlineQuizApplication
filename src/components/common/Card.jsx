...
const Card = ({
  ...
  if (!disabled) {
    return (
      <Link to={link}>
        <motion.div
          className={`cursor-pointer transition max-w-[300px] xs:min-w-[175px]  overflow-hidden duration-500 ease-in-out rounded-lg bg-white h-[300px] items-center text-center justify-center flex flex-col shadow-md backdrop-filter backdrop-blur-sm border
  ...
  return (
    <>
      ...
      >
        <motion.div
          className={`cursor-pointer max-w-[300px] xs:min-w-[175px]  relative overflow-hidden
          h-[300px]  transition duration-500 ease-in-out rounded-lg bg-white  items-center text-center justify-center  flex flex-col  
          shadow-md  backdrop-filter backdrop-blur-sm border border-red-500 hover:shadow-md hover:shadow-emerald-700 ${
            disabled ? "opacity-2  bg-gray-600" : ""
          }`}
